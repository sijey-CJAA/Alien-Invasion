...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        self.bg_image = pygame.image.load('images/galaxy6_bg.jpg')
        ...
        pygame.mixer.music.load('sounds/background_music.mp3')  # Change path to music file
    ...
    def _check_keydown_events(self, event):
        ...
        if event.key == pygame.K_RIGHT:
            ...
            self._fire_bullet()
            self.shoot_sound.play()  # Play the shooting sound when spacebar is pressed
    ...
    def _check_bullet_alien_collisions(self):
        ...
        if collisions:
            ...
            # Play the hit sound when a bullet hits an alien
            self.hit_sound.play()
